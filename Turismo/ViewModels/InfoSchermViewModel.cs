...
namespace Turismo.ViewModels
{
    ...
    { 
        ...
        public InfoSchermViewModel()
        {
            ...
            PauseLabel = new MultipleLanguageString("Met deze knop pauzeer je het lopen van een route. Dit bespaart Batterij", "This option will pause the map and will save battery life");
        }
    }
}
